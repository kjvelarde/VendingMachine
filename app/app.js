        ...
        _products = [
            {
                ...
                Price: 1.00,
                Quantity: 20,
                Image: 'http://icons.iconarchive.com/icons/michael/coke-pepsi/512/Coca-Cola-Can-icon.png'
        },
            {
                Name: 'Chips',
                Price: .50,
                Quantity: 20,
                Image: 'http://images.clipartpanda.com/bag-of-potato-chips-clipart-PngMedium-potato-chips-bag-16629.png'
        },
            {
                Name: 'Candy',
                Price: .60,
                Quantity: 2,
                Image: 'http://iconshow.me/media/images/xmas/christmas-icon11/2/candy-512.png'
        },
            {
                Name: 'Chocolate',
                Price: 2.50,
                Quantity: 0,
                Image: 'https://cdn.iconscout.com/public/images/icon/free/png-512/chocolate-bar-candy-dairymilk-sweet-dessert-food-emoj-symbol-39cddddcf33bb40e-512x512.png'
        },
            {
                Name: 'RedBull',
                Price: 3.00,
                Quantity: 0,
                Image: 'http://www.zandh.co.uk/media/catalog/product/cache/1/thumbnail/600x600/9df78eab33525d08d6e5fb8d27136e95/r/e/red_bull.png'
        }
	];;
...
app.controller('ctrl', function ($scope, $interval, $filter, productFactory) {
